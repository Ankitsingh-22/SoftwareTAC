...
function Navbar() {
    ...
    return (
        <Headroom>
            <div className="w-full px-6 md:px-20 py-4 flex justify-between items-center shadow-md z-50">
                {/* Logo */}
                <div className="logo">
                    <svg
                        width="72"
                ...
                {/* Navigation Links */}
                <div
                    className={`fixed top-0 right-0 h-full w-2/3 bg-gray-900 text-white z-40 transform ${
